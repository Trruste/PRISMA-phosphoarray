...
##
###and the MEFV candidates are removed (experiment 52 to 57) only for the protein groups otherwise it messes up with the data
...
proteinGroups <- read.delim("/Volumes/shared/TEMP/TR/phosphoproject/Katrina/proteinGroups.txt",stringsAsFactors = F)
...
candidates <- read.delim("S:/TEMP/TR/phospho project/Katrina/PeptideCandidates1.txt")
...
Cairo(file="S:/TEMP/TR/phospho project/Katrina/VolcanoPlots_trials/121022_Volcanoplots_1", type=ty, width=wi, height=he, pointsize=mte, dpi=re)
axlim <- 10.5
statistics <- "wcox"
...
# Create and export graph
Cairo(file=paste("/Users/trruste/Documents/12102022_SILACscatterplots_1_sameasVolcano_",exp_type,sep="_"), type=ty, width=wi, height=he, pointsize=mte, dpi=re)
enum <- -1
signrat <- 1
...
ggsave("S:/TEMP/TR/phospho project/paper/barchart_mean.pdf", plot = g1, width = 15, height = 10, dpi = 100)
